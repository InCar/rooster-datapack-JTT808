...
public class DataParserJTT808Test {
    ...
    public void begin() {
        byte[] data = {
                ...
                //2----------位置信息汇报
                0x7E, 0x02, 0x00, 0x00, 0x3C, 0x01, 0x33, 0x00, 0x31, 0x27, 0x07, 0x1B, 0x73, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, (byte) 0xC1, 0x01, (byte) 0xD1, 0x0B, (byte) 0xE4, 0x06, (byte) 0xD1, (byte) 0x90, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x17, 0x08, 0x24, 0x15, 0x32, 0x30, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x00, 0x03, 0x02, 0x00, 0x00, 0x25, 0x04, 0x00, 0x00, 0x00, 0x00, 0x2B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x30, 0x01, 0x15, 0x31, 0x01, 0x00, (byte) 0xD2, 0x7E,
                //3----------终端鉴权
    ...
    public void testExtractBody() {
        DataPack dataPack = parser.extract(buffer).get(3);
